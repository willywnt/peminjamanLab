...
@section('container')
        ...
        <div class="container">
            ...
            <div class="komputer">
                <p class="showed">Ruang LAB 402</p>
                <div class="comp-display">
                    <div class="comp">
                        ...
                        @csrf
                        <input type="hidden" id="code_lab" name="code_lab" value="L402-">
                        <input type="hidden" id="name_lab" name="name_lab" value="LAB 402">
                        <div id="computer">
