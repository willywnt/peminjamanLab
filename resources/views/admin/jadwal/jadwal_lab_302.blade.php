...
@section('title-content','Jadwal LAB 302')
@section('content','LAB 302')
...
<div class="card card-success">
  ...
  <tbody>
    ...
    <input type="hidden" name="lab" id="lab" value="LAB 302"/>
    <tr>
      <td>{{$today->hari}}</td>
      <td>{{$today->waktu}}</td>
      <td>{{$today->matkul}}</td>
...
<div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Table Data LAB 302</h3>
          <div class="card-tools">
      <button type="button" class="btn btn-tool" data-card-widget="collapse">
        <i class="fas fa-minus"></i>
      </button>
        ...
        <div class="card-body">
        <a href="{{url('/jadwal/view/302?page='.$days)}}">
